...
#define HC12_AGENT_CMD_EEPROM_ERASE_VERIFY 0x02
#define HC12_AGENT_CMD_EEPROM_ERASE_AREA   0x03
#define HC12_AGENT_CMD_EEPROM_READ         0x04
#define HC12_AGENT_CMD_EEPROM_WRITE        0x05
